...
<div class="toast max-w-xs bg-red-500 text-sm text-white rounded-xl shadow-lg p-4 flex items-center justify-between opacity-100 transition-opacity duration-500" role="alert">
    <span>{{ $error }}</span>
    <button type="button" class="close-button ml-3 text-white hover:text-opacity-75 focus:outline-none">
        <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M18 6L6 18"></path>
